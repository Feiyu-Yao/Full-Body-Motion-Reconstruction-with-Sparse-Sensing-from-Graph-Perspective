...
class SCINet_human_structure(nn.Module):
    ...
    def forward(self, all_joint):
        ...
        all_joint_new[:,0:11,:], all_joint_new[:,11:22,:]= self.interact_1(all_joint[:,0:11,:], all_joint[:,11:22,:])

        return all_joint_new[:,11:22,:]
...
class interactive_angle_and_position_1(nn.Module):
    def __init__(self, output_len, input_len, input_dim = 9, hid_size = 1, num_stacks = 1,
        ...
        super(interactive_angle_and_position_1, self).__init__()
