...
def main(json_path='options/test_avatar.json'):
    ...
    for index, test_data in enumerate(test_loader):
        ...
        rot_error_ = torch.mean(torch.absolute(gt_angle-predicted_angle.to(gt_angle.device)))
        ...
        rot_error.append(rot_error_.cpu())
        pos_error.append(pos_error_.cpu())
        vel_error.append(vel_error_.cpu())

        pos_error_hands.append(pos_error_hands_.cpu())
